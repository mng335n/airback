...
<@lib.headElements title="airback Setup Assistant Page"/>
...
<body>
    ...
    <div id="mainBody">
        <div id="title">
            <h1>Thank you for trial airback<h1>
        </div>
        <hr size="1" style="margin: 1px 0 20px 0; ">
        <div id="title">
            <h3>Welcome to the airback setup wizard. Please fill in the information below to complete the installation process.</h3>
            <h4>airback is well tested on various platforms include Windows, Linux and MacOS. We have been
                spending countless hours to do the installation testing on
                as many machines as possible. If you can not install airback successfully, please raise your case in
                 our <a href="https://airback.userecho.com/communities/3-general-help/topics/" target="_blank">Support
                 page</a></h4>
        </div>
        ...
        <div id="mainContent">
            <table style="width:100%">
                <tr>
                    <td style="vertical-align: top; width: 400px;"><div style="margin-top:10px;">airback SETUP</div></td>
                        ...
                        <form>
                            <table border="0" style="width:100%">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input id="sitename" value="airback"/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr><td><h4>You can get this info from your web host. It could be an IP address or server name. You must not include the server port in this value. If you want to change the server port, please use <a href="https://docs.airback.com/getting-started/configuration/">this way</a></h4></td></tr>
                                </tbody>
                            </table>
                        </form>
                    </td>
            ...
            <table style="width:100%;margin-top: 20px;">
                <tr>
                    <td style="vertical-align: top; width: 400px;"><div style="margin-top:10px;">DATABASE SETUP</div>
                        <h4>Configure your pre-created airback database schema</h4>
                    </td>
                    <td style="display: inline-block; vertical-align: top; width:100%">
                        <form>
                            <table border="0" style="width:100%">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input id="databaseName" placeholder="Example: airback"/></td>
                                    </tr>
                                    <tr><td><h4>Name of airback database. Database must be created before.</h4></td></tr>
                                    <tr>
            ...
            <table style="width:100%;margin-top: 20px;">
                <tr>
                    <td style="vertical-align: top; width: 400px;"><div style="margin-top:10px;">EMAIL SETUP (Optional)<div>
                        <h4>Configure your outgoing SMTP email address to use with the software. You can configure your SMTP account later in airback configuration file $\{airback_HOME}/conf/application.properties</h4>
                    </td>
                    <td style="display: inline-block; vertical-align: top; width:100%">
                        <form>
                            <table border="0" style="width:100%">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input id="smtpUserName" placeholder="Example: airback@airback.com"/></td>
                                    </tr>
                                    <tr>
...
function updateInfoAction(){
    ...
    $('#setupBtn').after('<p><h3 style=\"color:orange\">Please be patient! It may takes a few minutes to set up airback depends on your servers performance. Whenever the install process is completed, the browser redirects automatically to the application home page</h3></p>');
    var urlPost = "/install";
