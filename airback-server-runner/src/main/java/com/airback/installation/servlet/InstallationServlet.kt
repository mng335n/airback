...
class InstallationServlet : HttpServlet() {
    ...
    override fun doPost(request: HttpServletRequest, response: HttpServletResponse) {
        LOG.info("Try to install airback")
...
//        }
        ...
        */
        ...
        if (confFolder == null) {
            out.write("Can not write the settings to the file system. You should check our knowledge base article at " + "http://support.airback.com/topic/994098-/ to solve this issue.")
            return
        }
        ...
        if (!Files.isWritable(FileSystems.getDefault().getPath(confFolder.absolutePath))) {
            out.write("The folder ${confFolder.absolutePath} has no write permission with the current user." +
                    " You should set the write permission for airback process for this folder.  You should check our knowledge base article at http://support.airback.com/topic/994098-/ to solve this issue.")
            return
        }
        ...
        try {
            ...
            LOG.error("Error while set up airback", e)
            out.write("Can not write the settings to the file system. You should check our knowledge base article at http://support.airback.com/topic/994098-/ to solve this issue.")
        }
    }
