...
public class BusinessDayTimeUtils {
    ...
    public static LocalDate plusDays(LocalDate refDate, int lagDate) {
        ...
        if (lagDate >= 0) {
            calc1 = LocalDateKitCalculatorsFactory.forwardCalculator("airback");
            isForward = true;
        } else {
            calc1 = LocalDateKitCalculatorsFactory.backwardCalculator("airback");
        }
    ...
    public static int duration(LocalDate start, LocalDate end) {
        ...
        try {
            DateCalculator<LocalDate> calc1 = LocalDateKitCalculatorsFactory.forwardCalculator("airback");
