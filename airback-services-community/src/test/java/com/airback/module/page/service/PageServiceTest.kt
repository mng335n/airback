...
class PageServiceTest : IntegrationServiceTest() {
    ...
    fun setup() {
        val page = Page()
        page.createdUser = "anhminh@airback.com"
        page.category = "abc"
        page.path = "1/page/document_1"
        page.status = WikiI18nEnum.status_public.name
        page.subject = "Hello world"
        page.content = "My name is <b>Anh Minh</b>"
        pageService.savePage(page, "anhminh@airback.com")
    }
    ...
    fun testGetWikiPages() {
        val pages = pageService.getPages("1/page", "anhminh@airback.com")
    ...
    private fun savePage2() {
        ...
        page.content = "My name is <b>Dieu Ha</b>"
        page.status = WikiI18nEnum.status_private.name
        pageService.savePage(page, "anhminh@airback.com")

        val expectedPage = pageService.getPage("1/page/document_2", "anhminh@airback.com")
    ...
    fun testGetVersions() {
        ...
        val page2 = pageService.getPage("1/page/document_1", "anhminh@airback.com")
