 ...
 */
package com.airback.community.module.common.service.impl

import com.airback.common.domain.AggregateTag
...
class TagServiceImpl : TagService {
    ...
    override fun saveWithSession(@CacheKey record: Tag, username: String?): Int = -1

    override fun updateWithSession(@CacheKey record: Tag, username: String?): Int = -1

    override fun updateSelectiveWithSession(@CacheKey record: Tag, username: String?): Int? = null

    override fun massUpdateWithSession(record: Tag, primaryKeys: List<Int>, @CacheKey accountId: Int?) {
    }

    override fun findByPrimaryKey(primaryKey: Int, sAccountId: Int): Tag? = null
