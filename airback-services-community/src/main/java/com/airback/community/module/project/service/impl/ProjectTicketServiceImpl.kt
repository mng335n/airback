 ...
 */
package com.airback.community.module.project.service.impl

import com.airback.core.airbackException
import com.airback.module.project.domain.ProjectTicket
import com.airback.module.project.service.impl.AbstractProjectTicketServiceImpl
...
class ProjectTicketServiceImpl : AbstractProjectTicketServiceImpl() {
    override fun updateAssignmentValue(assignment: ProjectTicket, username: String) {
        throw airbackException("Not support this operation in the community edition")
    }
