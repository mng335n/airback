 ...
 */
package com.airback.schedule.spring

import com.airback.configuration.IDeploymentMode
import com.airback.module.project.schedule.email.service.OverdueProjectTicketsNotificationJob
import com.airback.schedule.AutowiringSpringBeanJobFactory
import com.airback.schedule.jobs.LiveInstanceMonitorJob
import com.airback.schedule.jobs.ProjectSendingRelayEmailNotificationJob
