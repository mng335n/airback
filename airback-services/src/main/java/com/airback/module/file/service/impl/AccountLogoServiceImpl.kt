 ...
 */
package com.airback.module.file.service.impl

import com.airback.core.airbackException
import com.airback.core.utils.ImageUtil
...
import com.airback.module.file.service.AccountLogoService
...
class AccountLogoServiceImpl(private val resourceService: ResourceService,
    ...
    override fun upload(uploadedUser: String, logo: BufferedImage, sAccountId: Int): String {
        val account = billingAccountService.getAccountById(sAccountId) ?: throw airbackException("There's no account associated with provided id $sAccountId")
    ...
    private fun uploadLogoToStorage(uploadedUser: String, image: BufferedImage, logoId: String, width: Int, sAccountId: Int?) {
        ...
        try {
            ...
            throw airbackException("Error while write image to stream", e)
        }
