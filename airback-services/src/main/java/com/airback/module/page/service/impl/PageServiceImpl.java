 ...
 */
package com.airback.module.page.service.impl;
                ...
                try {
                    ...
                    for (int i = 0; i < pathStr.length - 1; i++) {
                        ...
                        if (childNode != null) {
                            ...
                            // add node
                            childNode = parentNode.addNode(pathStr[i], "{http://www.airback.com/wiki}folder");
                    ...
                    Node addNode = parentNode.addNode(pathStr[pathStr.length - 1], "{http://www.airback.com/wiki}page");
        ...
        return jcrTemplate.execute(session -> {
            ...
            if (node != null) {
                if (isNodeFolder(node)) {
                    ...
                    throw new ContentException(String.format("Do not support any node type except airback:folder. The current node has type: %s and its path is %s",
            ...
            if (node != null) {
                if (isNodeFolder(node)) {
                    ...
                    throw new ContentException(
                            "Do not support any node type except airback:folder. The current node has type "
