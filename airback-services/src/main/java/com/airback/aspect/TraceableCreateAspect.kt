...
class TraceableCreateAspect(private var activityStreamService: ActivityStreamService) {
    ...
    @AfterReturning("execution(public * com.airback..service..*.saveWithSession(..)) && args(bean, username)")
    ...
    @AfterReturning("execution(public * com.airback..service..*.removeWithSession(..)) && args(bean, username, sAccountId)")
