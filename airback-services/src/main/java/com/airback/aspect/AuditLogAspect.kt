...
class AuditLogAspect(private var cacheService: CacheService,
    ...
    @Before("(execution(public * com.airback..service..*.updateWithSession(..)) || (execution(public * com.airback..service..*.updateSelectiveWithSession(..)))) && args(bean, username)")
    ...
    @AfterReturning("(execution(public * com.airback..service..*.updateWithSession(..)) || (execution(public * com.airback..service..*.updateSelectiveWithSession(..))))  && args(bean, username)")
