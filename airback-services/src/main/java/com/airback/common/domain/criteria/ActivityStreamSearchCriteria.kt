 ...
 */
package com.airback.common.domain.criteria
 ...
 * @since 1.0
 */
class ActivityStreamSearchCriteria : SearchCriteria() {

    var moduleSet: SetSearchField<String>? = null
    var extraTypeIds: SetSearchField<Int>? = null
    var createdUser: StringSearchField? = null
