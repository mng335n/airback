...
public class TestDbConfiguration {
    ...
    public TestDbConfiguration() {
        InputStream stream = getClass().getClassLoader().getResourceAsStream("airback.properties");
        if (stream == null) {
            LOG.info("Load the default configuration default-airback-test.properties");
            stream = getClass().getClassLoader().getResourceAsStream("default-airback-test.properties");
        }
