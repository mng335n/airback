 ...
 * @since 3.0
 */
@WebServlet(name = "airbackApplication", urlPatterns = ["/*"], asyncSupported = true, loadOnStartup = 0,
        initParams = [(WebInitParam(name = "closeIdleSessions", value = "false")),
            ...
            (WebInitParam(name = "org.atmosphere.useWebSocket", value = "true")),
            (WebInitParam(name = "org.atmosphere.websocket.WebSocketProtocol.executeAsync", value = "true")),
            (WebInitParam(name = "org.atmosphere.websocket.maxIdleTime", value = "886400000"))])
