...
import com.airback.core.SessionExpireException;
...
/**
 * The core class that keep user session data while user login to airback
...
public class UserUIContext implements Serializable {
    ...
    /**
     * Current user LOG in to airback
     */
    SimpleUser session;
    ...
    public UserUIContext() {
        airbackSession.putCurrentUIVariable("context", this);
    }
    ...
    public static UserUIContext getInstance() {
        try {
            UserUIContext context = (UserUIContext) airbackSession.getCurrentUIVariable("context");
            if (context == null) {
    ...
    /**
     * Update last module visit then the next sign in, airback will lead user
    ...
    public void setSessionVariables(SimpleUser userSession, SimpleBillingAccount billingAc) {
        ...
        airbackSession.putSessionVariable(airbackSession.USER_VAL, userSession);
    }
    ...
    public void clearSessionVariables() {
        session = null;
        billingAccount = null;
        airbackSession.removeSessionVariable(airbackSession.USER_VAL);
        airbackSession.removeCurrentUIVariable(airbackSession.PRESENTER_VAL);
        airbackSession.removeCurrentUIVariable(airbackSession.VIEW_MANAGER_VAL);
    }
