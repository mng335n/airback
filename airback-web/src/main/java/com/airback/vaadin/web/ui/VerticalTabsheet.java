...
public class VerticalTabsheet extends CustomComponent {
        ...
        if (!hasTab(id)) {
            ...
            if (parentId == null) {
                ...
                if (parentTab != null) {
                    ...
                    throw new airbackException("Not found parent tab with id " + parentId);
                }
            }

            compMap.put(id, tab);
        } else {
            throw new airbackException("Existing tab has id " + id);
        }
    }
    ...
    static {
        try {
            ...
            throw new airbackException("Internal error finding methods in TabSheet");
        }
    }
