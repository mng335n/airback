...
import com.airback.module.user.accountsettings.team.view.RoleListPresenter;
import com.airback.module.user.accountsettings.team.view.UserListPresenter;
...
import com.airback.vaadin.web.ui.ServiceMenu;
...
public class AccountModuleImpl extends AbstractSingleContainerPageView implements AccountModule {
    ...
    public AccountModuleImpl() {
        ...
        ExternalResource helpRes = new ExternalResource("https://docs.airback.com/user-guide/account-management/");
    ...
    private void buildComponents() {
        ...
        tabSheet.addTab(SettingUIConstants.SETTING, SettingUIConstants.GENERAL_SETTING,
                UserUIContext.getMessage(AdminI18nEnum.VIEW_CUSTOMIZATION), null, SettingAssetsManager.getAsset(SettingUIConstants.GENERAL_SETTING));
