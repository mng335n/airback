...
import com.airback.module.project.event.FileEvent;
...
import com.airback.vaadin.resources.LazyStreamSource;
import com.airback.vaadin.resources.OnDemandFileDownloader;
import com.airback.vaadin.resources.file.FileAssetsUtil;
...
import com.airback.vaadin.web.ui.UserLink;
    ...
    private class ResourcesContainer extends MVerticalLayout {
        ...
        private HorizontalLayout buildResourceRowComp(final Resource resource) {
            ...
            if (resource instanceof Folder) {
                ...
                throw new airbackException("Do not support resource file " + resource.getClass());
            }
