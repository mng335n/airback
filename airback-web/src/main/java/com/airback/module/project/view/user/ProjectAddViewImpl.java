...
import com.airback.vaadin.web.ui.I18nValueComboBox;
    ...
    private static class EditFormFieldFactory extends AbstractBeanFieldGroupEditFieldFactory<Project> {
        ...
        protected HasValue<?> onCreateField(final Object propertyId) {
            ...
            if (Project.Field.description.equalTo(propertyId)) {
                ...
                return UIUtils.INSTANCE.getComponent("com.airback.pro.module.project.view.client.ClientSelectionField");
