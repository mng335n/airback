...
import com.airback.module.project.view.ticket.TicketRelationSelectField;
                ...
                if (validateForm()) {
                    ...
                    if (BugResolution.Duplicate.name().equals(bug.getResolution())) {
                        if (ticketRelationSelectField != null && ticketRelationSelectField.getSelectedTicket() != null) {
                            ...
                            com.airback.module.project.domain.TicketRelation relatedTicket = new com.airback.module.project.domain.TicketRelation();
