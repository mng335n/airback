...
import com.airback.vaadin.ui.PropertyChangedEvent;
import com.airback.vaadin.ui.PropertyChangedListener;
import com.airback.vaadin.ui.UIUtils;
import com.airback.vaadin.web.ui.LazyPopupView;
    ...
    public void propertyChanged(PropertyChangedEvent event) {
        ...
        if ("status".equals(event.getBindProperty())) {
            ...
            try {
                ...
                boolean isClosed = StatusI18nEnum.Closed.name().equals(statusValue) || StatusI18nEnum.Verified.name().equals(statusValue);
                if (isClosed) {
