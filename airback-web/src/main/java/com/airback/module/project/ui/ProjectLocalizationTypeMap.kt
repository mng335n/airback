...
object ProjectLocalizationTypeMap {
    @JvmStatic fun getType(key: String): String = when (key) {
        ...
        ProjectTypeConstants.COMPONENT -> UserUIContext.getMessage(ComponentI18nEnum.SINGLE)
        ProjectTypeConstants.VERSION -> UserUIContext.getMessage(VersionI18nEnum.SINGLE)
