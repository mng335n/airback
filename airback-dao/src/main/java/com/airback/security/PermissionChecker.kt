...
object PermissionChecker {
    ...
    @JvmStatic fun isImplied(flag: Int, impliedVal: Int): Boolean {
        return when {
            ...
            else -> throw airbackException("Do not support permission category except boolean and access permission, the check permission is $flag")
        }
    }
}
