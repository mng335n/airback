...
import com.airback.reporting.ReportStyles
import com.airback.reporting.expression.DateExpression
import com.airback.reporting.expression.HumanTimeExpression
import com.airback.reporting.expression.I18nExpression
...
import com.airback.reporting.generator.HtmlBuilderGenerator
...
class ProjectColumnBuilderMapper : InitializingBean {
    ...
    private fun buildComponentMap(): Map<String, ComponentBuilderGenerator> {
        ...
        val map = mutableMapOf<String, ComponentBuilderGenerator>()
        val summaryTitleExpr = PrimaryTypeFieldExpression<String>(com.airback.module.project.domain.Component.Field.name.name)
        val summaryHrefExpr = object : AbstractSimpleExpression<String>() {
