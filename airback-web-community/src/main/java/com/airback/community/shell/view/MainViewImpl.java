 ...
 */
package com.airback.community.shell.view;

import com.airback.common.i18n.GenericI18Enum;
import com.airback.common.i18n.LicenseI18nEnum;
import com.airback.common.i18n.ShellI18nEnum;
import com.airback.common.ui.components.notification.RequestUploadAvatarNotification;
import com.airback.common.ui.components.notification.SmtpSetupNotification;
import com.airback.community.shell.view.components.AdRequestWindow;
import com.airback.community.vaadin.web.ui.NotificationComponent;
...
import com.airback.module.user.ui.SettingAssetsManager;
import com.airback.module.user.ui.SettingUIConstants;
import com.airback.shell.event.ShellEvent;
import com.airback.shell.view.AbstractMainView;
...
import com.airback.vaadin.web.ui.OptionPopupContent;
...
public class MainViewImpl extends AbstractMainView {
    ...
    protected MHorizontalLayout buildAccountMenuLayout() {
        ...
        ExternalResource helpRes = new ExternalResource("https://docs.airback.com/user-guide/");
        ...
        ExternalResource supportRes = new ExternalResource("https://airback.userecho.com/en/");
        ...
        ExternalResource translateRes = new ExternalResource("https://docs.airback.com/development/translating/");
        ...
        accountPopupContent.addSeparator();
        MButton aboutBtn = new MButton(UserUIContext.getMessage(ShellI18nEnum.OPT_ABOUT_airback), clickEvent -> {
            accountMenu.setPopupVisible(false);
        ...
        ExternalResource releaseNotesRes = new ExternalResource("https://docs.airback.com/releases/");
