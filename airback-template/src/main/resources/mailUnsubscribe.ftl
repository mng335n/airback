...
This account email has been sent to you as part of your airback membership.
...
<div style="color: ${styles.meta_color}; font:${styles.small_font}; display:inline-flex; padding: 0px 30px;">
    Copyright by <a href="https://www.airback.com">&nbsp;©&nbsp; airback ${current_year?c}</a>. All rights reserved.&nbsp;Connect with us:&nbsp;
